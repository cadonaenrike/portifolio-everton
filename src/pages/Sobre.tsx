      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-12">
        ...
        <section className={`mb-6 md:mb-10 ${bgColorClass}`}>
          ...
          <div className="space-y-4">
            <article className={`${bgColorClass} rounded-lg p-4 flex`}>
        ...
        <section className={`mb-6 md:mb-10 ${bgColorClass}`}>
          ...
          <div className="space-y-4">
            <article className={`${bgColorClass} rounded-lg p-4`}>
              <Image
                src={logoGrowdev}
              ...
              <p>
                O Programa Starter Full Stack Developer é uma formação completa
                que vai desde os fundamentos da programação e tecnologia até o
                desenvolvimento de um software completo, incluindo front-end,
                back-end, banco de dados e cache, com qualidade garantida por
                testes automatizados e implantação (deploy) do sistema em
                produção. Os alunos têm a oportunidade de aplicar seus
                conhecimentos em projetos contratados por empresas,
                desenvolvidos na fábrica de software da Growdev. O objetivo é
                proporcionar um aprendizado de qualidade e desenvolver as
                habilidades técnicas e interpessoais dos alunos. A grade
                curricular é dividida em blocos, incluindo Básico,
                Intermediário, Avançado e Profissional, com a adição de novos
                conteúdos enquanto se baseia no que já foi estudado em cada
                etapa.
              </p>
              <p>Competências: TypeScript</p>
            </article>
            <article className={`${bgColorClass} rounded-lg p-4`}>
              <Image
                src={logoUnicnec}
